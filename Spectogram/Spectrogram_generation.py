...
def Generate_Mono_Mag_Phase_Spectrogram (data,fs,subdirectory,filename):
     ...
     plt.xlabel('Time [sec]')
     plt.savefig('Spectrogram_Plots/Mag/'+str(subdirectory)+'_'+str(filename)+'_'+'Magnitude_Plot_Mono.png')
     plt.close()
     Phase, t_phase, Lxx_Phase = signal.spectrogram( x = data, fs = samplerate, window = 'hann', nperseg = 512,noverlap = 384,nfft =  1024,detrend='constant', return_onesided=True, scaling='density', axis=-1, mode='angle')
     plt.pcolormesh(t_phase, Phase, Lxx_Phase, cmap ='magma')
     plt.colorbar(label='Phase')
     plt.ylabel('Frequency [Hz]')
     plt.xlabel('Time [sec]')
     plt.savefig('Spectrogram_Plots/Phase/'+str(subdirectory)+'_'+str(filename)+'_'+'Phase_Plot_Mono.png')
     plt.close()
...
def Generate_Stereo_Spectrogram(data_left,data_right,fs,subdirectory,filename):
 ...
 plt.ylabel('Frequency [Hz]')
 plt.xlabel('Time [sec]')
 plt.savefig('Spectrogram_Plots/Mag/'+str(subdirectory)+'_'+str(filename)+'_'+'Magnitude_Plot_Left.png')
 plt.close()
 ...
 plt.ylabel('Frequency [Hz]')
 plt.xlabel('Time [sec]')
 plt.savefig('Spectrogram_Plots/Mag/'+str(subdirectory)+'_'+str(filename)+'_'+'Magnitude_Plot_Right.png')
 ...
 plt.ylabel('Frequency [Hz]')
 plt.xlabel('Time [sec]')
 plt.savefig('Spectrogram_Plots/Phase/'+str(subdirectory)+'_'+str(filename)+'_'+ 'Phase_Plot_Left.png')
 plt.close()
 ...
 plt.ylabel('Frequency [Hz]')
 plt.xlabel('Time [sec]')
 plt.savefig('Spectrogram_Plots/Phase/'+str(subdirectory)+'_'+str(filename)+'_' + 'Phase_Plot_Right.png')
 plt.close()
