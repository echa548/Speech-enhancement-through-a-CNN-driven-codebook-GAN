...
real_samples = np.load('Clean_PSD.npy')
noise = np.load('Mixture_PSD.npy')
...
current_epoch = 0
generator_model_path = "trained_wganlp_model_epoch_Dense_20_generator"
discriminator_model_path = "trained_wganlp_model_epoch_Dense_20_discriminator"
